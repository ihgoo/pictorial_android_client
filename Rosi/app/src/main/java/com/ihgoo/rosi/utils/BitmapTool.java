...
public class BitmapTool {
	...
	public static Bitmap saveZoomBitmapToSDCard(
			ByteArrayOutputStream byteArrayOutputStream, ScreenUtil.Screen screen,
	 ...
	 * @return 缩放后的图片bitmap
	 */
	public static Bitmap saveZoomBitmapToSDCard(Bitmap bitmap, ScreenUtil.Screen screen,
			String url, String cachePath, boolean isJpg) {
